...
namespace tgui  { namespace xhtml
{
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief The size preverence (can be used for height, width, ...)
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    struct SizePreference
    {
        bool       fixed;    //!< The size is fixed
        float      value;    //!< The size value in px
    };
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief The one dimensional size (can be used for font, height, width, ...)
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    struct OneDimSize
    {
        ...
        /// @param v      The size value
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        OneDimSize(SizeType t, float v)
            : sizeType(t), value(v)
        { ; }

        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Calculates this one dimension size equivalent in pixel out of the current size
        ///
        /// @param parentDimension  The parent dimension for the calculation of a relative defined size
        ///
        /// @return                 The one dimension size equivalent in pixel calculated out of the current size
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        inline OneDimSize toPixel(float parentDimension) const
        {
            if (sizeType == SizeType::Pixel)
                return OneDimSize(SizeType::Pixel, value);
            else if (sizeType == SizeType::Point)
                return OneDimSize(SizeType::Pixel, value * 1.3333333333f);
            else if (sizeType == SizeType::EquivalentOfM)
                return OneDimSize(SizeType::Pixel, value * 16.0f);
            else
                return OneDimSize(SizeType::Pixel, value * parentDimension);
        }
    };
    ...
    struct FourDimSize
    {
        ...
        ///
        /// @param type   The size type (size measuring unit)
        /// @param v      The size value (all four dimensions)
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        FourDimSize(SizeType type, float v)
            : sizeType(type), top(v), right(v), bottom(v), left(v)
        { ; }
