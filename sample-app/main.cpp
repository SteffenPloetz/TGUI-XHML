...
public:
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    std::shared_ptr<tgui::xhtml::FormattedDocument::FontCollection> createFontCollection()
    {
        auto fontCollection = std::make_shared<tgui::xhtml::FormattedDocument::FontCollection>();

        fontCollection->Sans = std::make_shared<tgui::xhtml::FormattedDocument::FontPack>();
        fontCollection->Serif = std::make_shared<tgui::xhtml::FormattedDocument::FontPack>();
        fontCollection->Mono = std::make_shared<tgui::xhtml::FormattedDocument::FontPack>();
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    void buildDom(tgui::xhtml::FormattedXhtmlDocument::Ptr FormattedDocument1)
    {
        ...
        auto a_BG = std::make_shared<tgui::xhtml::XhtmlStyleEntry>();
        a_BG->setBackgroundColor(tgui::Color(U"#DFD0D0"));
        auto a01 = tgui::xhtml::XhtmlElement::createAnchor(nullptr, a_BG, tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"Introduction to the FormattedTextArea (h2)"));
        a01->addAttribute(std::make_shared<tgui::xhtml::XhtmlAttribute>(U"href", U"#INTRO"));
        auto a02 = tgui::xhtml::XhtmlElement::createAnchor(nullptr, a_BG, tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"Various text tests (h2)"));
        a02->addAttribute(std::make_shared<tgui::xhtml::XhtmlAttribute>(U"href", U"#TEXTS"));
        auto a03 = tgui::xhtml::XhtmlElement::createAnchor(nullptr, a_BG, tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"Floating text and block text tests (h3)"));
        a03->addAttribute(std::make_shared<tgui::xhtml::XhtmlAttribute>(U"href", U"#FLOATING"));
        auto a04 = tgui::xhtml::XhtmlElement::createAnchor(nullptr, a_BG, tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"List tests (h3)"));
        a04->addAttribute(std::make_shared<tgui::xhtml::XhtmlAttribute>(U"href", U"#LISTS"));
        auto a05 = tgui::xhtml::XhtmlElement::createAnchor(nullptr, a_BG, tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"Code and style-sheet tests (h3)"));
        a05->addAttribute(std::make_shared<tgui::xhtml::XhtmlAttribute>(U"href", U"#CODE"));
        auto h2_BG00 = std::make_shared<tgui::xhtml::XhtmlStyleEntry>();
        h2_BG00->setBackgroundColor(tgui::Color(U"#D0DAD0"))
                .setMargin(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 12.0f))
                .setBorderStyle(tgui::xhtml::FourDimBorderStyle(tgui::xhtml::BorderStyle::Dotted))
                .setBorderWidth(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 3.0f))
                .setBorderColor(tgui::Color(U"#B0BAB0"))
                .setPadding(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 12.0f));
        ...
        h3_BG01->setBackgroundColor(tgui::Color(U"#D0D0DF"))
                .setMargin(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 8.0f))
                .setBorderStyle(tgui::xhtml::FourDimBorderStyle(tgui::xhtml::BorderStyle::Solid))
                .setBorderWidth(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 1.0f))
                .setBorderColor(tgui::Color(U"#B0B0BF"))
                .setPadding(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 8.0f));
        h3_FLOATING->addAttribute(h3_BG01);
        auto h4_CANGE_WIDTH = tgui::xhtml::XhtmlElement::createH4(nullptr, {tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"Change the witdth of the window to "),
        ...
        h4_CANGE_WIDTH->addAttribute(std::make_shared<tgui::xhtml::XhtmlAttribute>(U"id", U"CHANGE_WIDTH"));
        auto h4_BG01 = std::make_shared<tgui::xhtml::XhtmlStyleEntry>();
        h4_BG01->setBackgroundColor(tgui::Color(U"#D8D0D8"))
                .setMargin(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 4.0f))
                .setBorderStyle(tgui::xhtml::FourDimBorderStyle(tgui::xhtml::BorderStyle::Solid))
                .setBorderWidth(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 1.0f))
                .setBorderColor(tgui::Color(U"#B8B0B8"))
                .setPadding(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 4.0f));
        ...
        auto h4_NESTED_LIST = tgui::xhtml::XhtmlElement::createH4(nullptr, {tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"Nested list "),
                                                                            tgui::xhtml::XhtmlElement::createSpan(nullptr, std::make_shared<tgui::xhtml::XhtmlStyleEntry>(tgui::Color(U"#008800")), tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"tests")),
                                                                            tgui::xhtml::XhtmlElement::createInnerText(nullptr, U" (h4)") });
        h4_NESTED_LIST->addAttribute(std::make_shared<tgui::xhtml::XhtmlAttribute>(U"id", U"NESTED_LIST"));
        auto h4_BG02 = std::make_shared<tgui::xhtml::XhtmlStyleEntry>();
        h4_BG02->setBackgroundColor(tgui::Color(U"#D8D0D8"))
                .setMargin(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 4.0f))
                .setBorderStyle(tgui::xhtml::FourDimBorderStyle(tgui::xhtml::BorderStyle::Solid))
                .setBorderWidth(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 1.0f))
                .setBorderColor(tgui::Color(U"#B8B0B8"))
        ...
        auto a10 = tgui::xhtml::XhtmlElement::createAnchor(nullptr, a_BG, tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"Jump to: Top"));
        a10->addAttribute(std::make_shared<tgui::xhtml::XhtmlAttribute>(U"href", U"#HTML-MU"));
        ...
        auto silverBG = std::make_shared<tgui::xhtml::XhtmlStyleEntry>();
        silverBG->setBackgroundColor(tgui::Color(248, 248, 248, 255))
                 .setBorderStyle(tgui::xhtml::FourDimBorderStyle(tgui::xhtml::BorderStyle::Solid))
                 .setBorderWidth(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 1.0f))
                 .setBorderColor(tgui::Color(160, 160, 160, 192))
                 .setPadding(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 0.0f, 4.0f));
        auto h4_STYLED_CODE = tgui::xhtml::XhtmlElement::createH4(nullptr, {tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"Code with style sheet "),
                                                                            tgui::xhtml::XhtmlElement::createSpan(nullptr, std::make_shared<tgui::xhtml::XhtmlStyleEntry>(tgui::Color(U"#008800")), tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"test")),
                                                                            tgui::xhtml::XhtmlElement::createInnerText(nullptr, U" (h4)") });
        h4_STYLED_CODE->addAttribute(std::make_shared<tgui::xhtml::XhtmlAttribute>(U"id", U"STYLED_CODE"));
        auto h4_BG03 = std::make_shared<tgui::xhtml::XhtmlStyleEntry>();
        h4_BG03->setBackgroundColor(tgui::Color(U"#D8D0D8"))
                .setBorderColor(tgui::Color(U"#B8B0B8"))
                .setMargin(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 4.0f))
                .setBorderStyle(tgui::xhtml::FourDimBorderStyle(tgui::xhtml::BorderStyle::Solid))
                .setBorderWidth(tgui::xhtml::FourDimSize(tgui::xhtml::SizeType::Pixel, 1.0f))
        ...
        tgui::xhtml::XhtmlElement::addChildrenAndSetPatent(body, {
            ...
            list02,
            tgui::xhtml::XhtmlElement::createInnerText(nullptr, U"left-side text of a link "),
            a10,
            tgui::xhtml::XhtmlElement::createInnerText(nullptr, U" right-side text of a link"),
            h3_CODE,
            h4_STYLED_CODE,
            tgui::xhtml::XhtmlElement::createDivision(nullptr, tgui::xhtml::XhtmlElement::createPreformatted(nullptr, silverBG, code01)) });
    ...
    bool createFrameContent()
    {
        ...
        std::shared_ptr<tgui::xhtml::FormattedDocument::FontCollection> fontCollection = createFontCollection();
#ifdef _DEBUG
        std::cout << "'createFrameContent()'->font collection established" << std::endl;
#endif // _DEBUG

        auto FormattedDocument1 = tgui::xhtml::FormattedXhtmlDocument::create();
        ...
        auto FormattedDocument2 = tgui::xhtml::FormattedXhtmlDocument::create();
        ...
        if (html != nullptr)
            FormattedDocument2->setRootElement(html);
